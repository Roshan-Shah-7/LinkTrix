...
const Footer = () => {
    return (
        <footer className="tracking-wide bg-gray-950 px-10 py-12 border-t border-gray-800">
            <div className="flex flex-wrap justify-between gap-10 max-w-6xl mx-auto">
                    ...
                    <ul className="mt-8 flex space-x-5">
                        <li>
                            <a href='javascript:void(0)'>
                                <svg xmlns="http://www.w3.org/2000/svg" className="fill-white w-8 h-8 transition-transform duration-300 hover:scale-110" viewBox="0 0 49.652 49.652">
                        ...
                        <li>
                            <a href='javascript:void(0)'>
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 transition-transform duration-300 hover:scale-110" viewBox="0 0 112.196 112.196">
                        ...
                        <li>
                            <a href='javascript:void(0)'>
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 transition-transform duration-300 hover:scale-110" viewBox="0 0 152 152">
                        ...
                        <li>
                            <a href='javascript:void(0)'>
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 transition-transform duration-300 hover:scale-110" viewBox="0 0 1227 1227">
                ...
                <div className="max-lg:min-w-[140px]">
                    <h4 className="text-white font-semibold text-sm relative max-sm:cursor-pointer">Services</h4>

                    <ul className="mt-6 space-y-4">
                        <li>
                            <a href='javascript:void(0)' className="hover:text-white text-gray-400 text-sm font-normal transition-colors duration-300">Digital Marketing</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' className="hover:text-white text-gray-400 text-sm font-normal transition-colors duration-300">Web Development</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' className="hover:text-white text-gray-400 text-sm font-normal transition-colors duration-300">Software Development</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' className="hover:text-white text-gray-400 text-sm font-normal transition-colors duration-300">Branding</a>
                        </li>
                    </ul>
                </div>

                <div className="max-lg:min-w-[140px]">
                    <h4 className="text-white font-semibold text-sm relative max-sm:cursor-pointer">Additional</h4>
