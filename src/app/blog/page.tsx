...
export default function BlogPage() {
    ...
    const featuredPost = {
        ...
        content:
            "As we navigate through 2024, the web development landscape continues to evolve at an unprecedented pace. From AI-powered development tools to advanced frameworks, discover what's driving innovation in our industry.",
        author: "Rajesh Hamal",
    ...
    const handleFeaturedPostClick = () => {
        alert(`Opening article: ${featuredPost.title}`)
    }

    // Handle blog post click
    const handleBlogPostClick = (post: (typeof allBlogPosts)[0]) => {
        ...
        <div className="min-h-screen bg-white">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                                    {categories.map((category) => (
                                        <Button
                                            ...
                                            className={`h-auto p-4 flex flex-col items-center gap-2 rounded-xl transition-all duration-300 ${selectedCategory === category.name
                                    ...
                                    <div className="space-y-4">
                                        {trendingTopics.map((topic, index) => (
                                            <div
                                                ...
                                                className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-300 cursor-pointer group ${selectedTrendingTopic === topic ? "bg-black text-white" : "hover:bg-gray-50"
                                                    }`}
                                            >
                                                <TrendingUp
                                                    className={`h-4 w-4 transition-colors duration-300 ${selectedTrendingTopic === topic ? "text-white" : "text-gray-400 group-hover:text-black"
                                                        }`}
                                                />
                                                <span
                                                    className={`text-sm font-medium transition-colors duration-300 ${selectedTrendingTopic === topic ? "text-white" : "text-gray-700 group-hover:text-black"
                                                        }`}
                                                >
                                                    {topic}
                                                </span>
                                                <ChevronRight
                                                    className={`h-4 w-4 ml-auto transition-colors duration-300 ${selectedTrendingTopic === topic ? "text-white" : "text-gray-300 group-hover:text-black"
                                                        }`}
                                                />
                                            </div>
                                        ))}
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                                    ...
                                    <div className="p-12 lg:p-16 flex flex-col justify-center">
                                        <div className="space-y-6">
                                            <h3 className="text-3xl md:text-4xl font-bold text-black leading-tight group-hover:text-gray-700 transition-colors duration-300">
                                                {featuredPost.title}
                                            </h3>
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                            {displayedFilteredPosts.map((post) => (
                                <Card
                                    key={post.id}
                                    className="overflow-hidden bg-white shadow-xl border-0 rounded-2xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group cursor-pointer"
                                ...
                                >
                                    ...
                                    <div className="p-8">
                                        <div className="space-y-4">
                                            <h3 className="text-xl font-bold text-black leading-tight group-hover:text-gray-700 transition-colors duration-300 line-clamp-2">
                                                {post.title}
                                            </h3>
            ...
            <section className="w-full relative bg-black overflow-hidden" style={{ height: "400px" }}>
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full max-w-4xl px-8">
                    <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">Stay Updated</h2>
                    ...
                    {newsletterStatus === "success" ? (
                        ...
                        <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
                            <Input
                                ...
                                className={`h-14 flex-1 rounded-xl border-2 bg-white/10 backdrop-blur-sm text-white placeholder:text-gray-300 focus:border-white transition-colors duration-300 ${newsletterStatus === "error" ? "border-red-400" : "border-white/20"
                                    }`}
                            ...
                            <Button
                                ...
                                size="lg"
                                disabled={newsletterStatus === "loading"}
                                className="h-14 px-8 bg-white text-black hover:bg-gray-100 transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-105 rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                            >
